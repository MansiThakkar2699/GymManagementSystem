            ...
            <div class="box bounceInLeft animated">
                ...
                <form class="form1" id="log_in" method="POST" action="services/register_user.php">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fname" id="ff" placeholder="FIRST NAME"/>
                    </div>
                    <div class="form-group">
                        <label class="sr-only"></label>
                        <input type="text" class="form-control" name="lname" id="ff" placeholder="LAST NAME"/>
                    </div>
                    <div class="form-group">
                        <label class="sr-only"></label>
                    ...
                    <div class="form-group">
                        <label class="sr-only"></label>
                        <input type="date" placeholder="DATE OF BIRTH" class="form-control" name="bday" id="bd"/>
                    </div>
                    <div class="form-group">
                        <label class="sr-only"></label>
                        <input type ="radio"  name="gender" style="float:left;"  /><span style="color:white;float:left">Male&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <input type ="radio" name="gender" style="float:left;"  /><span style="color:white;float:left">Female</span>
                    </div>
                    <div class="form-group">
                        <label class="sr-only"></label>
                        <textarea type="text" name="Address" class="form-control" style="height: 100px;" placeholder="Enter Your .."></textarea>
                    </div>
                    <div class="form-group">
                        <label class="sr-only"></label>
