...
<head>
    <meta charset="UTF-8">
    <title>Food Detail | Fitness Hub Admin Template</title>
                        ...
                        <div class="panel panel-danger">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <i class="fa fa-fw fa-file-text-o"></i> Food Details
                                </h4>
                            ...
                            <div class="panel-body table-responsive">
                                <table class="table table-bordered" id="fitness-table">
                                    ...
                                    <tbody>
                                                    ...
                                                    <td colspan="2"><a class="edit btn btn-primary" href=<?php echo "edit_food.php?id=$row[idAttribute]";?>>
                                                    <i class="fa fa-fw fa-edit"></i> Edit
                                                    </a>
                                                    <a class="delete btn btn-danger delete-user" idAttribute=<?php echo $row['idAttribute'];?>><i class="fa fa-trash-o"> Delete</i> </a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
                                ...
                                <a class="edit btn btn-primary" href="add_food.php" >
	...
	$(document).ready( function () {
	    ...
	    $( ".delete-user" ).click(function() {
		  if(confirm("Are you sure you want to delete this record?"))
		  {
		  	...
		  	window.location.href = "../services/delete_food.php?idAttribute="+idAttribute;
		  }
		});
	} );
</script>
