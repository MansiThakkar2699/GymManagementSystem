...
<head>
    ...
    <title>Welcome to Fitness Hub Nutritionist Dashboard</title>
    ...
    <header class="header">
        <nav class="navbar navbar-static-top">
            <a href="#" class="logo">
                ...
                <p style="color: #fff; margin-top: 15px;"><span style="font-weight: bold; font-size: large; margin-left:-60px;">Fitness</span><span style="font-size: large;">Hub</span><img src="img/dot.png" alt="logo" align="left"></p>
                        ...
                        <div class="media profile-left">
                            ...
                            <div class="content-profile">
                                <h4 class="media-heading"> <?php 
                                        echo $_SESSION['NAME'];
                                    ?></h4>
                                <span class="text-default">Nutritionist</span>
                            </div>
                        </div>
                    </div>
                    <ul class="navigation">
                        ...
                        <li>
                            <a href="nutritionist_company_profile.php">
                            <i class="fa fa-university" style="font-size:14px" aria-hidden="true"></i>Company Profile
                            </a>
                        </li>
                        <li>
                            <a href="nutritionist_userlist.php">
                            <i class="fa fa-hand-o-right" style="font-size:2px;color:rgb(0, 140, 255)"></i> User List
                            </a>
                        </li>
                        <li class="menu-dropdown">
                            <a href="measurment.php">
                                <i class="text-success fa fa-fw fa-user"></i>
                                <span class="mm-text">Measurment</span>
                            </a>
                        </li>
                        <li class="menu-dropdown">
                            <a href="#">
                                <i class="fa fa-table" style="font-size:2px;color:rgb(195, 0, 255)"></i>
                                <span class="mm-text">Diet</span>
                                <span class="fa fa-angle-down pull-right"></span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="diet_list.php">
