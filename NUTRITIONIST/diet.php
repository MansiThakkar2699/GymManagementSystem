...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="admin_add_user.php" class="activated">Add Diet</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Add Diet
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/add_diet.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                            <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Diet Chart</label>
                                                    <div class="col-md-7 text-center">
                                                        <div class="input-group">
                                                           <input type="file" name="Diet_chart" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
