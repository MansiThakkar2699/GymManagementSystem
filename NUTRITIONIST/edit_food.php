<?php 
    ...
    $id = $_GET['id'];
    $sql="select * from attribute where idAttribute=$id";
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="admin_add_user.php" class="activated">Edit Food</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading" style="height:60px">
                                ...
                                <i class="fa fa-fw fa-user"></i>Edit Food
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/edit_food.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Foodtype; ?>" class="form-control" id="foodtype" placeholder="Food Type" name="Foodtype" required pattern="[a-z ,A-Z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Name; ?>" class="form-control" id="fname" placeholder="Food Name" name="Name" required pattern="[a-z ,A-Z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Protien; ?>" class="form-control" id="pro" placeholder="Protien" name="Protien" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Vitamins; ?>" placeholder="Vitamins" class="form-control" id="vita" name="Vitamins" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Calories; ?>" placeholder="Calories" class="form-control" id="cal" name="Calories" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Fat; ?>" placeholder="Fat" id="fat" class="form-control" name="Fat" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Carbohydrate; ?>" placeholder="Carbohydrate" id="carb" class="form-control" name="Carbohydrate" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Sodium; ?>" placeholder="Sodium" id="so" class="form-control" name="Sodium"required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Fiber; ?>" placeholder="Fiber" id="fiber" class="form-control" name="Fiber"  required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Sugar; ?>" placeholder="Sugar" id="sugar" class="form-control" name="Sugar" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"  value="<?php echo $Totalcalories; ?>" placeholder="Total Calories" id="tcal" class="form-control" name="Totalcalories" required/>
                                                        </div>
                                                    </div>
                                                </div>
