            ...
            <div class="container-fluid">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <!--main content-->
                        <div class="row">
                            <form method="POST" action="../services/Nedit_profile.php" enctype="multipart/form-data">
                                ...
                                <div class="col-md-9">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td><input type="text" name="First_name" value="<?php echo $First_name;?>" required pattern="[a-z ,A-Z ]{2,}"></td>
                                                                    
                                        </tr>
                                        <tr>
                                            <td>Last Name:</td>
                                        
                                            <td><input type="text" name="Last_name" value="<?php echo $Last_name;?>" required pattern="[a-z ,A-Z ]{2,}"></td>
                                                                    
                                        </tr>
                                        <tr>
                                            <td>Gender:</td>
                                            <td>
                                                <input type="text" name="gender" value="<?php echo ($gender == 0)?'Male':'Female';0?>" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Email:</td>
                                            <td><input type="text" name="Email_id" value="<?php echo $email;?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Phone Number:</td>
                                            <td><input type="number" name="Contact_no" value="<?php echo $contact;?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Date Of Birth:</td>
