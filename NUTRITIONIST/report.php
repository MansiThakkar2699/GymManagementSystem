...
<head>
    <meta charset="UTF-8">
    <title>Fitness Hub Nutritionist Template</title>
...
<?php include('N_masterpage.php');?>
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side right-padding">
            ...
            <a class="edit btn btn-primary" href="../Report/Customer Report.pdf"><i align="center"></i>CUSTOMER REPORT </a> 
            
  
            <a class="edit btn btn-primary" href="../Report/Measurement.pdf"><i align="center"></i>MEASUREMENT REPORT </a>
           
            <a class="edit btn btn-primary" href="../Report/Food.pdf"><i align="center"></i>FOOD REPORT </a><br><br>
