...
$sql="select batch.*,user_master.First_name,user_master.Last_name from batch INNER JOIN user_master ON batch.idUser_master=user_master.idUser_master";
...
<head>
    <meta charset="UTF-8">
    <title>Batch | Fitness Hub Admin Template</title>
        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="batch_list.php">Batch List</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <i class="fa fa-fw fa-file-text-o"></i>Batch List
                    </h4>
...
<script type="text/javascript">
	$(document).ready( function () {
	    ...
	    $( ".delete-user" ).click(function() {
		  ...
		  {
		  	var idBatch = $(this).attr('idBatch');
		  	window.location.href = "../services/delete_batch.php?idBatch="+idBatch;
		  }
		});
	} );
</script>
