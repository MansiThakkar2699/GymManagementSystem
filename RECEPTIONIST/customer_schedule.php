        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="customer_schedule.php">Customer Schedule</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
        ...
        function GetData(day)
        {
            ...
            $.post('../services/get_schedule.php',{
                ...
                if(_day == "Monday")
                {
                   ...
                   {
                        $('#mon_cont').append('<tr><td id="11">'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                }       
                else if(_day == "Tuesday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#tue_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                } 
                else if(_day == "Wednesday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#wed_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                }
                else if(_day == "Thursday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#thu_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                }
                else if(_day == "Friday")
                {
                   ...
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#fri_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                }
                else if(_day == "Saturday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#sat_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                } 
                else if(_day == "Sunday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#sun_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].btype+'</td><td>'+obj[i].timing+'</td><td>'+obj[i].tfname+" "+obj[i].tlname+'</td></tr>');
                   }  
                }                         
            });
        }
