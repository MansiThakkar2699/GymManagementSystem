...
$sql="select * from user_master where role_idRole=2 or role_idRole=5";
...
<head>
    <meta charset="UTF-8">
    <title>Users List | Fitness Hub Receptionist Template</title>
                            ...
                            <div class="panel-body table-responsive" style="border:1px solid #fc7070">
                                <table class="table table-bordered" id="fitness-table">
                                    ...
                                    <tbody>
                                            ...
                                            ?></td>
                                            <td>
                                            	<input class="btn btn-primary" type="button" id="btn_<?php echo $row['idUser_master'] ?>" value="Present" name="" onclick="AddAttendance(<?php echo $row['idUser_master'] ?>)"/>
                                            </td>
                                        </tr>
                                    <?php
                                    }
...
<script type="text/javascript">
	...
	{
		$.post('../services/add_attendance.php',{
			id:id
		},function(data){
			if(data == 401)
            {
                alert("Aleady Submitted Today's Attendance");
            }
            else if(data == 200)
            {
