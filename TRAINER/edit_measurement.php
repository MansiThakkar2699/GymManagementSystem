<?php 
    ...
    $id = $_GET['id'];
    $sql="SELECT * FROM measurment WHERE idMeasurment=$id";
    ...
    while($row = $result->fetch_assoc())
    {
        ...
        $waist= $row['waist'];
        $thigh= $row['thigh'];
        $upper_arm= $row['upper_arm'];
        $fore_arm= $row['fore_arm'];
        $cid=$row['idUser_master'];
    }

    $sql1="select * from user_master WHERE role_idRole = 5";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Measurment | Fitness Hub Trainer Template</title>
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="edit_measurement.php" class="activated">Edit Measurement</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Edit Measurement
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/edit_measurement.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $age; ?>" class="form-control" id="age" placeholder="Age" name="age" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $weight; ?>"  class="form-control" id="wg" placeholder="Weight" name="weight" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $height; ?>"  placeholder="Height" class="form-control" id="hg" name="height" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $BMI; ?>" placeholder="Body Mass Index" id="bmi" class="form-control" name="BMI" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $fat; ?>" class="form-control" id="fat" placeholder="Fat" name="fat" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $neck; ?>" class="form-control" id="neck" placeholder="Neck" name="neck" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $shoulder; ?>" class="form-control" id="sh" placeholder="Shoulder" name="shoulder" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $chest; ?>" class="form-control" id="ch" placeholder="Chest" name="chest" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $waist; ?>" class="form-control" id="wa" placeholder="Waist" name="waist" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $thigh; ?>" class="form-control" id="th" placeholder="Thigh" name="thigh" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $upper_arm; ?>" class="form-control" id="uarm" placeholder="Upper Arm" name="upper_arm" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $fore_arm; ?>" class="form-control" id="farm" placeholder="Fore Arm" name="fore_arm" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
     function ClearFields()
     {
         ...
         document.getElementById("uarm").value="";
