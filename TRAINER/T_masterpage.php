...
<head>
    ...
    <title>Welcome to Fitness Hub Trainer Dashboard</title>
    ...
    <header class="header">
        <nav class="navbar navbar-static-top">
            <a href="index-2.html" class="logo">
                ...
                <p style="color: #fff; margin-top: 15px;"><span style="font-weight: bold; font-size: large; margin-left:-50px;">Fitness</span><span style="font-size: large;">Hub</span><img src="img/dot.png" alt="logo" align="left"></p>
                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            ...
                            <li>
                                <?php
                                    ...
                                    $sql = "SELECT * FROM attendance WHERE idUser_master = $UID";
                                                ...
                                                <div class="message-body">
                                                    <strong>    
                                                        <?php
                                                            ...
                                                            $sql_user = "SELECT* FROM user_master WHERE idUser_master = $id";

                                                            $result_user = $conn->query($sql_user);
                                                                                
                                                            while($row_user = $result_user->fetch_assoc()) 
                                                            {
                                                                echo "You Are Present Today"."\t\t\t\t".$row['created_at'];
                                                            }
                                                        ?>
                                                    </strong>
                                                    <span class="noti-date"></span>
                                                </div>
                                            </a>
                                        <?php   
                                    }
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                                <img src="../ADMIN/profile/<?php echo $row1['img'];?>" width="40" class="img-circle img-responsive pull-left" height="35" alt="User Image">
                            <div class="riot">
                                <div>
                                <?php 
                                        echo $_SESSION['NAME'];
                    ...
                    <div class="nav_profile">
                        <div class="media profile-left">
                            ...
                            <div class="content-profile">
                                ...
                                <span class="text-default">Trainer</span>
                            </div>
                        </div>
                    </div>
                    <ul class="navigation">
                        ...
                        <li class="menu-dropdown">
                            ...
                            <i class="fa fa-cog" aria-hidden="true"  style="font-size:2px;color:rgb(255, 174, 0)"></i>
                                <span class="mm-text">Measurement</span>
                            </a>
                            </li>
                         <li class="menu-dropdown">
                            <a href="#">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="T_Excercise.php">
                                            <i class="fa fa-hand-o-right" style="font-size:2px;color:rgb(0, 140, 255)"></i>
                                             <span class="mm-text">Exercise List</span>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li>
                            <a href="schedule.php">
                                ...
                                <span class="mm-text"> Trainer Schedule</span>
                            </a>
                        </li>
                    </ul>
                    <!-- / .navigation -->
