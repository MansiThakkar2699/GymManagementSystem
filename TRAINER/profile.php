...
<head>
    <meta charset="UTF-8">
    <title>User Profile | Fitness Hub Receptionist Template</title>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            //echo $email;die;
                            $sql="select * from user_master where role_idRole=2 and Email_id='$email'";
                            ...
                            { 
                                ...
                                { ?>
	        		                <img src="<?php  echo '../ADMIN/profile/'.$row['img']; ?>" height="100" width="100">
	        		            <?php	
	        	                }
	        	                else
	        	                { ?>
                            ...
                            <br/><br/>
                             ...
                             <a class="delete btn btn-danger delete-user" id="delete_prof_pic" data-id="<?php echo $row['img']; ?>"><i class="fa fa-trash-o"> Delete</i> </a>
                            </div>
                            <div class="col-md-9">
