<?php 
    ...
    $id = $_GET['id'];
    $sql="select * from exercise where idExercise=$id";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Exercise | Fitness Hub Trainer Template</title>
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="edit_exercise.php" class="activated">Edit Exercise</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Edit Exercise
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/edit_exercise.php" class="form-horizontal" method="POST">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $type; ?>" class="form-control" id="ename" placeholder="Exercise type" name="type" required pattern="[a-z ,A-Z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $name; ?>" class="form-control" id="ename" placeholder="Exercise Name" name="name" required pattern="[a-z ,A-Z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="<?php echo $detail; ?>"  class="form-control" id="desc" placeholder="Description" name="detail" required >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
