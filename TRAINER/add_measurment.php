...
<head>
    <meta charset="UTF-8">
    <title>Add Measurment | Fitness Hub Trainer Template</title>
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="add_measurment.php" class="activated">Add Measurment</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Add Measurment
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/add_measurement.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                            <div class="form-body">
                                            <div class="form-group">
                                                    ...
                                                    <option value>Select User</option>
                                                            ...
                                                            {
                                                                ?>
                                                                <option value="<?php echo $row['idUser_master'] ;?>"><?php echo $row['First_name'].' '.$row['Last_name']; ?></option>
                                                                <?php
                                                            }
                                                            ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="wg" placeholder="Weight" name="weight" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="Height" class="form-control" id="hg" name="height" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="Body Mass Index" id="bmi" class="form-control" name="BMI" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="fat" placeholder="Fat" name="fat" required >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="neck" placeholder="Neck" name="neck" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="sh" placeholder="Shoulder" name="shoulder" required >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="ch" placeholder="Chest" name="chest" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="wa" placeholder="Waist" name="waist" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="th" placeholder="Thigh" name="thigh" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="uarm" placeholder="Upper Arm" name="upper_arm" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="farm" placeholder="Fore Arm" name="fore_arm" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $.post('../services/get_user_list.php',{},function(data){
            var user_object = Object();
            user_object = jQuery.parseJSON(data);

            for(var i=0;i<user_object.length;i++)
            {
                $('#user_list_sel').append('<option value="'+user_object[i].idUser_master+'">'+user_object[i].First_name+" "+user_object[i].Last_name+'</option>');
            }
        });
    </script>
    <script>
