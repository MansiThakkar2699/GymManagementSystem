...
<div class="super_container">
	...
	<div class="timetable">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/d1.jpg" data-speed="0.8"></div>
	...
	<!-- Team -->
	<div class="team">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/rockF10.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="section_title_container">
				...
				<div class="col-lg-3 team_col">
					<div class="team_item">
						<div class="team_image">
							...
							{
							?>
							<img src="<?php  echo '../ADMIN/profile/'.$row['img']; ?>" alt="">
							<?php
							}
							else
							{
								?>
								<img src="<?php  echo '../ADMIN/profile/basic.jpg'; ?>" alt="Team Image">
								<?php
							}
							?>
						</div>
						<div class="team_panel d-flex flex-column align-items-center justify-content-center text-center">
							...
							<div class="team_title"><?php  echo $row['First_name']; ?></div>
						</div>
					</div>
				</div>
