<?php
    ...
    $sql="SELECT * FROM Activity where idUser_master='$id' ORDER BY Time";
    // echo $sql;die;
...
<div class="super_container">
	...
	<div class="services">
		<div class="container">
			...
			<div>
			<?php
				$sql1="select * from diet where idUser_master='$id'";
				$res_diet=$conn->query($sql1);
				while($row_diet=$res_diet->fetch_assoc())
				{
					echo $row_diet['Diet_chart'];
				}
			?>
			</div>
		</div>
                            ...
                            <div class="tt_day">
                                ...
                                <div class="tt_day_content grid">
                                    ...
                                    <div class="tt_class grid-item weight_loss">
                                        <div class="tt_class_title"><?php echo $row1['Activity_name']; ?></div>
                                        <div class="tt_class_time"><?php echo $row1['Activity_name']; ?></div>
                                    </div>
