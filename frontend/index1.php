...
<div class="super_container">
	...
	<div class="home">
		<div class="background_image" style="background-image:url(images/d11.jpeg)"></div>
					...
					<div class="col">
						<div class="home_content text-center">
							<div class="video_link">
								<a class="vimeo video_button d-flex flex-column align-items-center justify-content-center" href="..\ADMIN\uploads\video\Boxing.mp4">
				...
				<div class="col">
					<div class="boxes_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
						...
						<div class="box">
							...
							<div class="box_text">
								<p>Pilates aims for elegant economy of movement, creating flow through the use of appropriate transitions.</p>
							</div>
						...
						<!-- Box -->
						<div class="box">
							<div class="box_icon d-flex flex-column align-items-center justify-content-center"><img src="images/icon_5.png" alt=""></div>
							<div class="box_title">Yoga</div>
							<div class="box_text">
								<p>Yoga maintains that chakras are center points of energy, thoughts, feelings, and the physical body. </p>
							</div>
							<!--<div class="box_link_container">
								<a href="#"><div class="box_link d-flex flex-column align-items-center justify-content-center trans_200"><div>+</div></div></a>
							</div>-->
				...
				<div class="col-lg-6">
					<div class="about_content">
						<div class="section_title_container">
							...
							<div class="section_title">About <span>Fitness HUB</span></div>
						</div>
						<div class="about_text">
							<p><div class="text_highlight" align="justify">A Fitness Hub is a place that houses exercise equipment for the 
						...
						"company providing people, access to controlled environmental condition space and services
						 focused on physical fitness and health in exchange of a fee."</div></p>
						</div>
			...
			<div class="container fill_height">
				<div class="row fill_height">
					<div class="col-lg-6 offset-lg-6 fill_height">
						<div class="about_image"><img src="images/d4.png" alt=""></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-6">
					...
					<!--<div class="test test_1 d-flex flex-row align-items-start justify-content-start">
						...
						<div class="test_content">
							<div class="test_name"><a href="#">abcdefg</a></div>
			...
			<div class="row">
				<div class="col">
					<div class=" d-flex flex-row align-items-start justify-content-start">
						<div class="section_title_container">
							<div class="section_subtitle">welcome to Fitness Hb</div>
