...
<head>
    <meta charset="UTF-8">
    <title>Edit Package | Fitness Hub Admin Template</title>
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="admin_edit_package.php" class="activated">Edit Package</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Edit Package
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/edit_package.php" class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="lname" placeholder="Package Name" name="Name" value="<?php echo $Name; ?>" required pattern="[a-z ,A-Z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="duration"" placeholder="Duration" name="Duration" value="<?php echo $Duration; ?>" required >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control" id="sd" placeholder="Start Date" name="start_date" value="<?php echo $start_date; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control" id="ed" placeholder="End Date" name="end_date" value="<?php echo $end_date; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="amt" placeholder="Amount" name="amount" value="<?php echo $amount; ?>" required >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
