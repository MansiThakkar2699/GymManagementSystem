                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-success" style="border:1px solid #65a800">
                            ...
                            <a class="edit btn btn-primary" href="add_schedule.php" style="margin:10px">
        ...
        function GetData(day)
        {
            ...
            $.post('../services/get_schedule.php',{
                ...
                if(_day == "Monday")
                {
                   ...
                   {
                        $('#mon_cont').append('<tr><td id="11">'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a><a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                }       
                else if(_day == "Tuesday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#tue_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a><a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                } 
                else if(_day == "Wednesday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#wed_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a><a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                }
                else if(_day == "Thursday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#thu_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a><a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                }
                else if(_day == "Friday")
                {
                   ...
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#fri_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                }
                else if(_day == "Saturday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#sat_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a><a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                } 
                else if(_day == "Sunday")
                {
                   for(var i=0;i<obj.length;i++)
                   {
                        $('#sun_cont').append('<tr><td>'+obj[i].fname+" "+obj[i].lname+'</td><td>'+obj[i].workout_type+'</td><td>'+obj[i].sub_workout_type+'</td><td>'+obj[i].timing+'</td><td colspan=2><a class="btn btn-primary" href="edit_schedule.php?id='+obj[i].idSchedule+'"><i class="fa fa-fw fa-edit"></i> Edit </a><a class="delete btn btn-danger delete-user" onclick=DeleteSchedule('+obj[i].idSchedule+')><i class="fa fa-trash-o"> Delete</i></a></td></tr>');
                   }  
                }                         
            });
        }
...
<script type="text/javascript">
    ...
    function DeleteSchedule(id)
    {
        ...
        {
            window.location.href = "../services/delete_schedule.php?idSchedule="+id;
        }
    }
</script>
