...
<head>
    <title>Forgot | Fitness Hub Forgot Password Template</title>
    ...
    <div class="container">
        <div class="full-content-center">
            <div class="box bounceInLeft animated">
                ...
                <form class="form" id="forgot_password" method="POST" action="../services/CustomerMail.php">
                    <div class="form-group">
                        <label class="sr-only"></label>
                        <input type="email" class="form-control" name="Email_id" placeholder="Email" required>
                    </div>
                    <input type="submit" class="btn btn-block btn-warning" value="Submit" name="forgot">
                </form>
            </div>
        </div>
    </div>
