...
$sql="select payment.*,user_master.Email_id,package.Name from payment LEFT JOIN user_master ON user_master.idUser_master = payment.user_id LEFT JOIN package ON package.idPackage = payment.package_id";
...
<head>
    <meta charset="UTF-8">
    <title>Payment List | Fitness Hub Admin Template</title>
        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="payment.php">Payment List</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <i class="fa fa-fw fa-file-text-o"></i> Payment List
                    </h4>
