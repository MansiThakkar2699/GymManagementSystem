...
<head>
    <meta charset="UTF-8">
    <title>Company Profile | Fitness Hub Admin Template</title>
                            ...
                            <div class="panel-body table-responsive" style="border:1px solid #fc7070">
                                <table class="table table-bordered" id="fitness-table">
                                    ...
                                    <tbody>
                                                    ...
                                                    { ?>
                                                    <tr>
	        		                                <td><img src="<?php  echo 'profile/'.$row['img']; ?>" height="100" width="100"></td>
                                                    <td><?php echo $row['Company_name'];?></td>
                                                    <td><?php echo $row['Owner_name'];?></td>
                                                    <td><?php echo $row['Address'];?></td>
                                                    <td><?php echo $row['Email_id'];?></td>
                                                    <td><?php echo $row['Contact_no'];?></td>
                                                    <td colspan="2"><a class="edit btn btn-primary" href=<?php echo "edit_company_profile.php?id=$row[idCompany]";?>>
                                                    <i class="fa fa-fw fa-edit"></i> Edit
                                                    </a>
                                                    <a class="delete btn btn-danger delete-user" idCompany=<?php echo $row['idCompany'];?>><i class="fa fa-trash-o"> Delete</i> </a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
	...
	$(document).ready( function () {
	    ...
	    $( ".delete-user" ).click(function() {
		  if(confirm("Are you sure you want to delete this record?"))
		  {
		  	...
		  	window.location.href = "../services/delete_company_profile.php?idCompany="+idCompany;
		  }
		});
	} );
</script>
