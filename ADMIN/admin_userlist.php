...
$sql="select * from user_master where role_idRole != 1";
                            ...
                            <div class="panel-body table-responsive" style="border:1px solid #fc7070">
                                <table class="table table-bordered" id="fitness-table">
                                    ...
                                    <tbody>
	        	                                    ...
	        	                                    { ?>
	        		                                <td><img src="<?php  echo 'profile/basic.jpg'; ?>" height="100" width="100"></td>
	        		                                <?php
	        	                                    } ?>  
                                                    ...
                                                    <td colspan="2"><a class="edit btn btn-primary" href=<?php echo "admin_edit_user.php?id=$row[idUser_master]";?>>
                                ...
                                <a class="edit btn btn-primary" href="admin_add_user.php" >
