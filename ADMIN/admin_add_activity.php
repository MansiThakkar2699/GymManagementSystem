...
<head>
    <meta charset="UTF-8">
    <title>Add Activity | Fitness Hub Admin Template</title>
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="admin_add_activity.php" class="activated">Add Activity</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Add Activity
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form1" method="POST"  action="../services/add_activity.php" class="form-horizontal">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name" placeholder="Activity Name" name="Activity_name" required pattern="[A-Z ,a-z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <!--<div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                    <select id="select_t" class="form-control js-states select2" name="idUser_master">
