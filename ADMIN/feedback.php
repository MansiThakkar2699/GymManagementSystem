...
$sql="select feedback.*,user_master.First_name,user_master.Last_name from feedback INNER JOIN user_master ON feedback.idUser_master=user_master.idUser_master";
...
<head>
    <meta charset="UTF-8">
    <title>feedback | Fitness Hub Admin Template</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <i class="fa fa-fw fa-file-text-o"></i>Feedback
                    </h4>
                            ...
                            <div class="panel-body table-responsive" style="border:1px solid #fc7070">
                                <table class="table table-bordered" id="fitness-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="delete btn btn-danger delete-user" idFeedback=<?php echo $row['idFeedback'];?>><i class="fa fa-trash-o"> Delete</i> </a></td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
	$(document).ready( function () {
	    ...
	    $( ".delete-user" ).click(function() {
		  ...
		  {
		  	var idFeedback = $(this).attr('idFeedback');
		  	window.location.href = "../services/delete_feedback.php?idFeedback="+idFeedback;
		  }
		});
	} );
</script>
