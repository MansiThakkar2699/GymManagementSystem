...
<head>
    <meta charset="UTF-8">
    <title>Edit Activity | Fitness Hub Admin Template</title>
...
<aside class="right-side right-padding" > 
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="admin_edit_activity.php" class="activated">Edit Activity</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                    ...
                    <div class="col-lg-12" >
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <i class="fa fa-fw fa-user"></i>Edit Activity
                            </h4>
                            ...
                            <div class="panel-body" style="border:1px solid #33a4d8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="add_users_form" action="../services/edit_activity.php" class="form-horizontal" method="POST">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name" placeholder="Activity Name" name="Activity_name" value="<?php echo $Activity_name; ?>" required pattern="[A-Z ,a-z ]{2,}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="time" class="form-control" id="time" placeholder="Time" name="Time" value="<?php echo $Time; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select id="select23" class="form-control js-states select2" name="Day">
                                                            <optgroup>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label  col-md-3" for="select23">Trainer:</label>
                                                    <div class="col-md-7">
                                                        <select id="select_t" class="form-control js-states select2" name="idUser_master" value="<?php echo $tid; ?>">
                                                            <optgroup>
                                                                <?php  
                                                                $qry="select DISTINCT user_master.First_name,user_master.idUser_master from user_master,activity where (activity.idUser_master = user_master.idUser_master) or user_master.role_idRole=2 and activity.idActivity=$id";
                                                                ...
                                                                {
                                                                ?>
                                                                <option value="<?php echo $row1['idUser_master'];?>"> <?php echo $row1['First_name'];?></option>
                                                                <?php }?>
                                                            </optgroup>
                                                        </select>
                                                    </div>
   ...
   function ClearFields()
   {
       ...
       document.getElementById("select_t").value="";
