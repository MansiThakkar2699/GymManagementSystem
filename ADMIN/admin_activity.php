...
$sql="select activity.*,user_master.First_name,user_master.Last_name from activity INNER JOIN user_master ON activity.idUser_master=user_master.idUser_master";
...
<head>
    <meta charset="UTF-8">
    <title>Activity List | Fitness Hub Admin Template</title>
        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="admin_activity.php">Activity List</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <i class="fa fa-fw fa-file-text-o"></i>Activity List
                    </h4>
                            ...
                            <div class="panel-body table-responsive" style="border:1px solid #fc7070">
                                            ...
                                            <?php
                                                ...
                                                { ?>
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><a class="edit btn btn-primary" href=<?php echo "admin_edit_activity.php?id=$row[idActivity]";?>>
                                                        <i class="fa fa-fw fa-edit"></i> Edit
                                                        </a>
                                                        <a class="delete btn btn-danger delete-user" idActivity=<?php echo $row['idActivity'];?>><i class="fa fa-trash-o"> Delete</i> </a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
                                ...
                                <a class="edit btn btn-primary" href="admin_add_activity.php">
...
<script type="text/javascript">
	$(document).ready( function () {
	    ...
	    $( ".delete-user" ).click(function() {
		  ...
		  {
		  	var idActivity = $(this).attr('idActivity');
		  	window.location.href = "../services/delete_activity.php?idActivity="+idActivity;
		  }
		});
	} );
